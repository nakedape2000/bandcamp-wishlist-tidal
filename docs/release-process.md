...
2. Run `bun run verify:m9` and the package smoke sequence in
   `docs/m9-verification.md`, including tests, type checking, formatting, and
   packaged-install inspection.
